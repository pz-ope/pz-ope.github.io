...
![image-20210823195854409](../Download/Typora/image/image-20210823195854409.png)

**NIO**

NIO在传输数据时，会在输入输出端之间建立**通道**，然后将数据放入到**缓冲区**中。缓冲区通过通道来传输数据

![image-20210823200023525](../Download/Typora/image/image-20210823200023525.png)
...
![image-20210824205248571](../Download/Typora/image/image-20210824205248571.png)
...
<img src="../Download/Typora/image/image-20210824205524961.png" alt="image-20210824205524961" style="zoom: 67%;" />
...
![image-20210824205940385](../Download/Typora/image/image-20210824205940385.png)
...
<img src="../Download/Typora/image/image-20210824210649795.png" alt="image-20210824210649795" style="zoom:67%;" />
...
![image-20210823200557715](../Download/Typora/image/image-20210823200557715.png)
...
![image-20210823201033017](../Download/Typora/image/image-20210823201033017.png)
...
![image-20210823201144799](../Download/Typora/image/image-20210823201144799.png)
...
![image-20210823201218704](../Download/Typora/image/image-20210823201218704.png)
...
![image-20210823201343729](../Download/Typora/image/image-20210823201343729.png)
...
![image-20210823201426141](../Download/Typora/image/image-20210823201426141.png)
...
![image-20210827091908886](../Download/Typora/image/image-20210827091908886.png)
...
![image-20210823201625812](../Download/Typora/image/image-20210823201625812.png)
...
![image-20210823201928804](../Download/Typora/image/image-20210823201928804.png)
...
![image-20210823202048113](../Download/Typora/image/image-20210823202048113.png)
...
![image-20210823202111510](../Download/Typora/image/image-20210823202111510.png)

于是便有了**Channel(通道)**，Channel相当于一个**专门用于IO操作的独立处理器**，它具有独立处理IO请求的能力，当有IO请求时，它会自行处理这些IO请求

![image-20210823202133082](../Download/Typora/image/image-20210823202133082.png)

### 3、Java Channel

#### 常用实现类

![image-20210823202149809](../Download/Typora/image/image-20210823202149809.png)
...
![image-20210823202245931](../Download/Typora/image/image-20210823202245931.png)
...
![image-20210823202309146](../Download/Typora/image/image-20210823202309146.png)
...
![image-20210823202349344](../Download/Typora/image/image-20210823202349344.png)
...
![image-20210823202409254](../Download/Typora/image/image-20210823202409254.png)
...
![image-20210823202451890](../Download/Typora/image/image-20210823202451890.png)
...
![image-20210823202513248](../Download/Typora/image/image-20210823202513248.png)
...
![image-20210823202535126](../Download/Typora/image/image-20210823202535126.png)
...
![image-20210823202632004](../Download/Typora/image/image-20210823202632004.png)
...
![image-20210823202646996](../Download/Typora/image/image-20210823202646996.png)
...
![image-20210827112624039](../Download/Typora/image/image-20210827112624039.png)

> 删除多级目录

![image-20210827140344573](../Download/Typora/image/image-20210827140344573.png)

> 拷贝目录

![image-20210827143114906](../Download/Typora/image/image-20210827143114906.png)
...
<img src="../Download/Typora/image/image-20210827132911649.png" alt="image-20210827132911649" style="zoom: 67%;" />

- 客户端-服务器建立连接后，客户端发送消息前：服务器端因通道为空被阻塞

<img src="../Download/Typora/image/image-20210827132953223.png" alt="image-20210827132953223" style="zoom:67%;" />

- 客户端发送数据后，服务器处理通道中的数据。再次进入循环时，再次被accept阻塞

<img src="../Download/Typora/image/image-20210827133017002.png" alt="image-20210827133017002" style="zoom:67%;" />

- 之前的客户端再次发送消息**，服务器端因为被accept阻塞**，无法处理之前客户端发送到通道中的信息

<img src="../Download/Typora/image/image-20210827133038177.png" alt="image-20210827133038177" style="zoom:67%;" />
...
![image-20210827162309563](../Download/Typora/image/image-20210827162309563.png)
...
<img src="../Download/Typora/image/image-20210827171018379.png" alt="image-20210827171018379" style="zoom:67%;" />
...
<img src="../Download/Typora/image/image-20210827133520646.png" alt="image-20210827133520646" style="zoom:67%;" />
...
![image-20210827133544793](../Download/Typora/image/image-20210827133544793.png)
...
<img src="../Download/Typora/image/image-20210827133758458.png" alt="image-20210827133758458" style="zoom:67%;" />
...
![image-20210827133832886](../Download/Typora/image/image-20210827133832886.png)

下文的消息边界处理方式为**第二种：按分隔符拆分**

![](../Download/Typora/image/image-20210828103201696.png)
...
![image-20210829095056913](../Download/Typora/image/image-20210829095056913.png)

![image-20210829100532854](../Download/Typora/image/image-20210829100532854.png)
...
![image-20210829112456897](../Download/Typora/image/image-20210829112456897.png)

根据UNIX 网络编程 - 卷 I，IO模型主要有以下几种

### 阻塞IO

![image-20210829112644401](../Download/Typora/image/image-20210829112644401.png)

- 用户线程进行read操作时，**需要等待操作系统执行实际的read操作**，此期间用户线程是被阻塞的，无法执行其他操作

### 非阻塞IO

![image-20210829112743669](../Download/Typora/image/image-20210829112743669.png)
...
![image-20210829112758973](../Download/Typora/image/image-20210829112758973.png)
...
![image-20210829112910880](../Download/Typora/image/image-20210829112910880.png)
...
![image-20210829114406387](../Download/Typora/image/image-20210829114406387.png)
...
![image-20210829115759267](../Download/Typora/image/image-20210829115759267.png)
...
![image-20210829115825981](../Download/Typora/image/image-20210829115825981.png)
...
![image-20210829115841359](../Download/Typora/image/image-20210829115841359.png)
